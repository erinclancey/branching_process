...
With estimates based on past outbreaks in hand, what can we say about may happen after future spillover events? What are the chances that we have not yet seen the "worst case scenario" and that even larger outbreaks are coming? 

For example, from the estimates above with R = 0.7, k = 0.08, what is the probability that a singles spillover event will result in an outbreak of 100 or more cases?
