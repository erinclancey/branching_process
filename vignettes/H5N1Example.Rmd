...
This parameterization is equivalent to using `mu = R` and `size = k` in R's `NegBinomial`, e.g. `dnbinom(x, mu=R, size=k)` would give the density, i.e. the probability of exactly $x$ transmissions from one individual.
